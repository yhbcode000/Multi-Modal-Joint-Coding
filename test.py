# -*- coding: utf-8 -*-
"""
Created on Mon Mar  2 19:45:58 2020
    ...
    for i, batch_data in enumerate(loader):
        ...
        with torch.no_grad():
            ...
            if mode != 'test_prediction' and mode != 'test_completion':
                ...
                result.evaluate(pred.data.cpu(), gt.data.cpu(), photometric_loss)
            [
...
def main():
    ...
    if is_eval:
        ...
        result, is_best = iterate("test_completion", args, val_loader, model, None, logger,
                                  checkpoint['epoch'])
        return
